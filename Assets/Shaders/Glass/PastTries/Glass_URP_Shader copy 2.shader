Shader "My_Shaders/Glass_URP_Shader_2"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                float3 rR_vs = mul(UNITY_MATRIX_V, float4(refractionR, 0)).xyz;
                float3 rG_vs = mul(UNITY_MATRIX_V, float4(refractionG, 0)).xyz;
                float3 rB_vs = mul(UNITY_MATRIX_V, float4(refractionB, 0)).xyz;
                ...
                half3 cubeSample;
                cubeSample.r = SAMPLE_TEXTURECUBE_LOD(_ReflectionCube, sampler_ReflectionCube, refractionR, _ReflectionDetail).r;
                cubeSample.g = SAMPLE_TEXTURECUBE_LOD(_ReflectionCube, sampler_ReflectionCube, refractionG, _ReflectionDetail).g;
                cubeSample.b = SAMPLE_TEXTURECUBE_LOD(_ReflectionCube, sampler_ReflectionCube, refractionB, _ReflectionDetail).b;
